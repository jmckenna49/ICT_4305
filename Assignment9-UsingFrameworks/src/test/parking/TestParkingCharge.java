...
public class TestParkingCharge {
    ...
    @Test
    public void testParkingChargeEquals() {
        ParkingCharge charge1 = new ParkingCharge("PERMIT-123", "LOT-001", timestamp, amount);
        ParkingCharge charge2 = new ParkingCharge("PERMIT-123", "LOT-001", timestamp, amount);
        ParkingCharge charge3 = new ParkingCharge("PERMIT-999", "LOT-999", timestamp, amount);
    ...
    @Test
    public void testParkingChargeHashCode() {
        ParkingCharge charge1 = new ParkingCharge("PERMIT-123", "LOT-001", timestamp, amount);
        ParkingCharge charge2 = new ParkingCharge("PERMIT-123", "LOT-001", timestamp, amount);

        assertEquals(charge1.hashCode(), charge2.hashCode());
    }

    @Test
    public void testParkingChargeEqualsWithDifferentFields() {
        Instant time2 = timestamp.plusSeconds(3600);
        ParkingCharge base = new ParkingCharge("PERMIT-123", "LOT-001", timestamp, amount);
        ParkingCharge diffPermit = new ParkingCharge("PERMIT-999", "LOT-001", timestamp, amount);
        ParkingCharge diffLot = new ParkingCharge("PERMIT-123", "LOT-999", timestamp, amount);
        ParkingCharge diffTime = new ParkingCharge("PERMIT-123", "LOT-001", time2, amount);

        assertNotEquals(base, diffPermit);
        assertNotEquals(base, diffLot);
        assertNotEquals(base, diffTime);
    }

    @Test
    public void testParkingChargeEqualsWithNull() {
        assertNotEquals(null, charge);
    }

    @Test
    public void testParkingChargeEqualsWithDifferentClass() {
        assertFalse(charge.equals("Not a parking charge"));
    }
}
