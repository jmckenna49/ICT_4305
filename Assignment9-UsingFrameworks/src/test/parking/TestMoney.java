...
public class TestMoney {
    ...
    public void testMoneyEquals() {
        ...
        assertEquals(money1, money1); // reflexive
    }
    ...
    @Test
    public void testMoneyEqualsWithZero() {
    ...
    @Test
    public void testMoneyEqualsWithNull() {
        Money money = new Money(500);
        assertNotEquals(null, money);
    }

    @Test
    public void testMoneyEqualsWithDifferentClass() {
        Money money = new Money(500);
        assertFalse(money.equals("Not money"));
    }
}