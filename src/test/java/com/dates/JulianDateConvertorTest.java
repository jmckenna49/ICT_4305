...
class JulianDateConvertorTest {
	...
	/**
	 * This test case will test pass when we will get julian number of 2470166 for date 25/12/2050.
	 */
	@Test
	void testDateToJulian_25122050() {
		...
		assertEquals(2470166, julian.convertDateToJulian());
	}
	...
	void testJulianToDate_25122050() {
		...
		int julianNumber = 2470166;
		JulianDateConvertor julianConvertor = new JulianDateConvertor(julianNumber);
		
		assertEquals("25-12-2050", julianConvertor.convertJulianToDate());
	}
	...
	void testDateStringToJulian_25122050() {
		...
		JulianDateConvertor julianConvertor = new JulianDateConvertor(dateString);
		assertEquals(2470166, julianConvertor.convertDateToJulian());
	}
	
	/**
	 * This test case will test pass when we will get julian number of 2266076 for date 15/03/1492.
	 */
	@Test
	void testDateToJulian_15031492() {
		...
		int month = 03;
		int year = 1492;
		JulianDateConvertor julianConvertor = new JulianDateConvertor(day,month,year);
		assertEquals(2266076, julianConvertor.convertDateToJulian());
	}
	...
	void testJulianToDate_15031492() {
		int julianNumber = 2266076;
		JulianDateConvertor julianConvertor = new JulianDateConvertor(julianNumber);
		
		assertEquals("15-3-1492", julianConvertor.convertJulianToDate());
	}
